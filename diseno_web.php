            ...
            <div class="container">
                ...
                <div class="carousel-inner">
                    <div class="item active">
                        ...
                        <img src="img/soluc1.png" class="adaptar">
                        <br>
                        <p align="center">Soluciones Informaticas</p>
                    </div>
                    <div class="item">
                        <img src="img/soluc3.jpg" class="adaptar">
                        <br>
                        <p align="center">Soluciones Informaticas</p>
                    </div>
                    <div class="item">
                        <img src="img/cam1.png" class="adaptar">
                        <br>
                        <p align="center"><font color="blue">Soluciones Informaticas</font></p>
                    </div>
                </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="row">
                            <div class="col-xs-12 col-sm-9 col-md-12 col-lg-12">
                                <h4>Dise&ntilde;o Web y Tiendas Online</h4><hr>
                                <p align="justify">Realizamos p&aacute;ginas Web y Tiendas Online para Empresas, Pymes y Aut&oacute;nomas</p>
                                <section class="color5">
                                    <br>Todas nuestras web son:
                                    <br>
                                    <br><li>100% Adaptables a Dispositivos M&oacute;viles y Tablets.</li>
                                    <br><li>100% Optimizadas para buscadores</li>
                                    <br><li>100% Webs Autogestionables.</li>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-9 col-md-12 col-lg-12">
                                <h3> <span class="icon-display"> Dise&ntilde;o Web</span></h3><hr>
                                <section class="color5">
                                    <li>Dise&ntilde;o Web Funcional y Amigable.</li>
                                    <br><li>Mantenimientos web.</li>
                                    <br><li>Web Promocionales.</li>
                                    <br><li>Soporte T&eacute;cnico Online.</li>
                                </section>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-9 col-md-12 col-lg-12">
                                <h3><span class="icon-cart"> TIENDAS ONLINE</span></h3><hr>
                                <section class="color5">
                                    <br><li>Tiendas Online Personalizadas.</li>
                                    <br><li>Tiendas Online Gestionables.</li>
                                    <br><li>Productos, Categotias y atributos.</li>
                                    <br> Vende por internet las 24 horas 7 dias a la semana desde cualquier dispositivo y en cualquier parte del mundo.
                                </section>   
                            </div>
                        </div>
                    </div>
