...
<html class="no-js">
    ...
    <body background="img/web.jpg">
        ...
        <div class="panel-heading">
            <h2 class="color3" >REGISTRO DE USUARIOS</h2>
            </div>
            ...
            <form  method="post" action="">
                <div class="comment-form">
                    ...
                    <div class="form-group">
                     <label class="control-label color3" for="nombre">Nombre</label>
                     <input type="text" class="form-control" name="nombre"  autofocus="true" maxlength="150" placeholder="Nombre" required="true" />
                    ...
                    <div class="form-group">
                      ...
                      <input type="email"  class="form-control" name="correo"  maxlength="100" placeholder="E-Mail"  required="true"/>

                        <div class="help-block"></div>
                       </div>
                   
                    <div class="form-group">
                        <label  for="pais" class="color3">Pa&iacute;s</label>
                  <select name="pais" class="form-control">
                   ...
                   <div class="help-block"></div>
                    ...
                    <h3 class="color3">REDES SOCIALES</h3>
                    
                    <div class="form-group">
                        <label  for="facebook" class="color3">Facebook</label>
                        <input type="text" class="form-control" name="facebook"  maxlength="150" placeholder="https://www.facebook.com/tuNick" />

                        <div class="help-block"></div>
                    </div>
                    
                    <div class="form-group ">
                    <label class="control-label color3" for="twitter">Twitter</label>
                    <input type="text"  class="form-control" name="twitter" maxlength="150" placeholder="https://www.twitter.com/tuNick" />
                    <div class="help-block"></div>
                    </div>
    
    
                   <div class="form-group ">
                       <label  for="blog" class="color3">Blog</label>
                   <input type="text" id="comment-name" class="form-control" name="blog"  maxlength="150" placeholder="http://www.tublog.com" />

                   <div class="help-block"></div>
                   </div>
                    
                    <H3 class="color3"> CONTRASE&Ntilde;A</H3>
                    
                    <div class="form-group ">
                        <label  for="pass" class="color3">Contrase&ntilde;a</label>
                       <input type="password"  class="form-control" name="pass"  maxlength="150" placeholder="Contrase&ntilde;a"  required="true"/>

                        <div class="help-block"></div>
                    </div>

                   <div class="form-group ">
                       <label  for="pass_2" class="color3">Repetir Contrase&ntilde;a</label>
                      <input type="password"  class="form-control" name="pass_2"  maxlength="150" required placeholder="Repetir Contrase&ntilde;a" required="true"/>
